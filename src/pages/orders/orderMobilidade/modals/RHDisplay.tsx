...
const localData =
{
  ...
  vr_order: {
    whats_vt: true,
    already_has_another_solution: false,
    point_solution_name: "Teste",
    number_of_users: 35,
    average_value_per_employee: 850,
        ...
        <div className="mt-4 text-neutral-700">
          <div className="bg-white rounded-md p-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {localData.order_type === "MOBILIDADE" &&
                vrOrder?.["whats_vt"] !== undefined && (
                  <>
                    <DisplayGenerator
                      title="Interesse VT:"
                      value={formatYesNo(vrOrder?.["whats_vt"])}
                    />
                    <DisplayGenerator
                      title="Já possui outra solução:"
                      value={formatYesNo(vrOrder?.["already_has_another_solution"])}
                    />
                    <DisplayGenerator
                    ...
                    <DisplayGenerator
                      ...
                      value={String(vrOrder?.["number_of_users"] ?? "-")}
                    />
                    <DisplayGenerator
