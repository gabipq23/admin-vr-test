...
export const useMobilidadeTableColumns = (): TableColumnsType<VROrder> => {
    ...
    return [
        ...
        {
            title: "Interesse VT",
            dataIndex: ["vr_order", "whats_vt"],
            width: 120,
            render: (whats_vt) =>
                typeof whats_vt === "boolean"
                    ? whats_vt
                        ? "Sim"
                        : "Não"
                    : "-",
        ...
        {
            title: "Possui outra solução",
            dataIndex: ["vr_order", "already_has_another_solution"],
            width: 180,
            render: (already_has_another_solution) =>
                typeof already_has_another_solution === "boolean"
                    ? already_has_another_solution
                        ? "Sim"
                        : "Não"
                    : "-",
        },
        ...
        },
        {
            ...
            dataIndex: ["vr_order", "number_of_users"],
            width: 130,
            render: (number_of_users) => number_of_users ?? "-",
        },
        {
            title: "Valor médio colaborador",
            dataIndex: ["vr_order", "average_value_per_employee"],
            width: 190,
            render: (average_value_per_employee) =>
