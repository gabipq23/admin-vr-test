...
export const useRHTableColumns = (): TableColumnsType<VROrder> => {
    ...
    return [
...

        {
            ...
            dataIndex: ["vr_order", "already_has_another_benefit"],
            width: 190,
            render: (already_has_another_benefit) =>
                typeof already_has_another_benefit === "boolean"
                    ? already_has_another_benefit
                        ? "Sim"
                        : "Não"
                    : "-",
        },
        {
            ...
            dataIndex: ["vr_order", "benefit_name"],
            ellipsis: {
                showTitle: false,
            },
            width: 160,
        ...
        {
            title: "Nº beneficiários",
            dataIndex: ["vr_order", "number_of_beneficiaries"],
            width: 150,
            render: (number_of_beneficiaries) => number_of_beneficiaries ?? "-",
        },
        {
            title: "VA",
            dataIndex: ["vr_order", "whats_va"],
            width: 70,
            render: (whats_va) =>
                typeof whats_va === "boolean" ? (whats_va ? "Sim" : "Não") : "-",
        },
        {
            title: "Valor médio VA",
            dataIndex: ["vr_order", "average_value_per_employee_va"],
            width: 140,
            render: (average_value_per_employee_va) =>
                average_value_per_employee_va !== null &&
                    average_value_per_employee_va !== undefined
                    ? formatBRL(average_value_per_employee_va)
                    : "-",
        },
        {
            title: "VR",
            dataIndex: ["vr_order", "whats_vr"],
            width: 70,
            render: (whats_vr) =>
                typeof whats_vr === "boolean" ? (whats_vr ? "Sim" : "Não") : "-",
        },
        {
            title: "Valor médio VR",
            dataIndex: ["vr_order", "average_value_per_employee_vr"],
            width: 140,
            render: (average_value_per_employee_vr) =>
                average_value_per_employee_vr !== null &&
                    average_value_per_employee_vr !== undefined
                    ? formatBRL(average_value_per_employee_vr)
                    : "-",
        },
        {
            title: "Vale Auto",
            dataIndex: ["vr_order", "whats_vale_auto"],
            width: 100,
            render: (whats_vale_auto) =>
                typeof whats_vale_auto === "boolean"
                    ? whats_vale_auto
                        ? "Sim"
                        : "Não"
                    : "-",
        ...
        {
            title: "Valor médio Vale Auto",
            dataIndex: ["vr_order", "average_value_per_employee_vale_auto"],
            width: 180,
            render: (average_value_per_employee_vale_auto) =>
                average_value_per_employee_vale_auto !== null &&
                    average_value_per_employee_vale_auto !== undefined
                    ? formatBRL(average_value_per_employee_vale_auto)
                    : "-",
        },
